...
class RewindFifteenSecondsButton extends StatelessWidget {
  const RewindFifteenSecondsButton({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SkipSecondsIconButton(
      flipped: true,
      onPressed: () => myAudioPlayerState.rewindFifteenSeconds(),
    );
  }
}
